...
/**
 * Depending on the settings success the modem, the responses will be formatted differently. Therefore
 * you will need to create a new framer whenever you change any success the settings that affect
 * the formatting.
 */
