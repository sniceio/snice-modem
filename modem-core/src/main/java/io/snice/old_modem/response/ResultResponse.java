...
/**
 * <p>
 *     Represents a result response issued by the modem. There are threee kinds of results codes:
 *     <ul>
 *         <li><Final: A final result code indicates the completion of a full DCE action and a willingness to accept new
 * commands from the DTE.</li>
 *         <li>Intermediate: An intermediate result code is a report of the progress of a DCE action</li>
